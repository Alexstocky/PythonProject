...
line1 = canvas.create_line((150,0),(150,150),width=5)
line2 = canvas.create_line((0,150),(100,150), width=5)

wallsArray = [canvas.coords(line1), canvas.coords(line2)]
...
def detect():
    for n in range(0,len(wallsArray)):
        if canvas.coords(roomba) == wallsArray[n]:
            move = False
